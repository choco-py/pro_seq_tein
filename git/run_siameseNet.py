...
#  )
os.chdir(
   '/Users/soheehwang/git/KISS_siameseNet'
 )
...
# %%
data_save_dir = './model_save/data_server/data/'
...
if len(data_check) == 0:
    ...
    with open('model_save/data_server/data/train_data.pickle', 'wb') as f:
        pickle.dump(train_data, f, pickle.HIGHEST_PROTOCOL)

        print('Train Data Save.')

    # save
    with open('model_save/data_server/data/test_data.pickle', 'wb') as f:
...
siamese_net = SiameseNet(
    ...
    input_protein_shape=(None, 403, 768),
    buffer_size=1280,
)
...
if train_ok:
    siamese_net.train_SiamNet(
        input_finger1=train_data['PTFP'].tolist(),
        ...
        input_protein=train_data['BERT'].tolist(),
...
pred = siamese_net.evaluate_SiamNet(
    ...
    input_protein=subset_data['RATIO'].tolist(),
