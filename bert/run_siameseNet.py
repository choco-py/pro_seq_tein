...
if train_ok:
    siamese_net.train_SiamNet(
        input_finger1=train_data['PAIR'].tolist(),
    ...
    # input_finger6=sub_data['PAIR'].tolist(),
        input_finger6=train_data['PTFP'].tolist(),
...
for a in range(3,6):
    sub_data = train_data.iloc[a*5000:(a+1)*5000]
#sub_data = train_data.iloc[15000:20000]
    print('sub_data_shape: ')
    print(a)
    ...
    if train_ok:
        ...
        # input_finger6=sub_data['PAIR'].tolist(),
            ...
            pre_trained_path='./model_save/kinase_6th'#None,#'./model_save/reuse',
        )
# %%
